<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="11" :value="old('phone')" required autocomplete="tel" />
